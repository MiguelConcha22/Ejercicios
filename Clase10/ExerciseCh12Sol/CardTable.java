   ...
   public CardTable(String cardset) {
      ...
      for (int suit = 0; suit <= 3; suit++) {
         ...
         for (int rank = 1; rank <= 13; rank++) {
        	//Tuve que cambiar la ruta desde la raiz, osino no funcionaba
            String s = String.format("/home/miguel/eclipse-workspace/Clase10/src/ExerciseCh12/%s/%02d%c.gif",
                                    cardset, rank, c);
