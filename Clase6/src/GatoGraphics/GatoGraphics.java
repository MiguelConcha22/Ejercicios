...
public class GatoGraphics extends JFrame {
   ...
   public GatoGraphics() {
	   try {
		    img = ImageIO.read(new File("cruz.png"));
		} catch (IOException e) {
		}
      ...
      /*boolean Graphics.drawImage(BufferedImage img,
              int x, int y,
   ...
   public static void main(String[] args) {
      ...
      SwingUtilities.invokeLater(
         ...
         @Override
         public void run() {
            new GatoGraphics(); // Let the constructor do the job
         }
      }
      );
   }
